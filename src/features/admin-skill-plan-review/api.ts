...
export const adminSkillPlanReviewApi = {
  ...
  verify: (evidenceId: number, approved: boolean, verifierNotes?: string) =>
    http
      .put<SkillPlanEvidenceDto>(`/api/admin/skill-plan-evidence/${evidenceId}/verify`, { approved, verifierNotes })
      .then((r) => r.data),
};
